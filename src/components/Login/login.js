...
const Login = (props) => {
  ...
  const fomSubmit = (value) => {
    ...
    if (password.value.length === 0) {
      ...
      props
        .getLoginThunk(login.value, password.value, check, null)
        .then((id) => {
          navig(`/profile/${id}`);
        });
    }
    ...
    <div>
      <Container
        ...
        <Box
          ...
          <div>
            <Button variant="contained" onClick={fomSubmit}>
              Login
            </Button>
          </div>
        </Box>
        <Box
          sx={{ border: '1px solid black', borderRadius: '10px', p: 3, mt: 2 }}>
          ...
          <Box>
            ...
            <div
              ...
              free@samuraijs.com
              <div className={s.title} id="titleCopy">
                click to copy
              </div>
              <div className={s.title} id="titleCopyСopied">
                login copied
              </div>
            </div>
          </Box>
          <Box>
            ...
            <div
              ...
              free
              <div className={s.title} id="titleCopyPass">
                click to copy
              </div>
              <div className={s.title} id="titleCopyСopiedPass">
                password copied
              </div>
            </div>
          </Box>
