            ...
            maxWidth='xs'
                ...
                <DialogContent sx={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <FormControl fullWidth  size='small'>
                        ...
                        >
                            <MenuItem value={'#8efa8e'} sx={{background: '#8efa8e'}}>Green</MenuItem>
                            <MenuItem value={'#f3f372'} sx={{background: '#f3f372'}}>Yellow</MenuItem>
                            <MenuItem value={'#c796f5'} sx={{background: '#c796f5'}}>Violet</MenuItem>
                            <MenuItem value={'#0072E5'} sx={{background: '#0072E5'}}>Standart</MenuItem>
                        </Select>
                    </FormControl>
                </DialogContent>
                <DialogActions>
