        ...
        <>
          <Box sx={{ flexGrow: 2 }}>
            <Card sx={{ minWidth: { md: 552, xs: '100%' }, mb: 2, mr: 3 }}>
              ...
              <CardMedia
                ...
                height="250"
                image={
                  props.news.arrNews.find((a) => a.id === activeNews).photo
                }
                alt="news1"
              />
              <CardContent>
          ...
          <Box sx={{ flexGrow: 1 }}>
            {props.news.arrNews
              ...
              .reverse()}
            <Button variant="outlined" onClick={allNewsHandler} sx={{ mb: 2 }}>
              Show all news
            </Button>
          </Box>
        </>
