...
const News = (props) => {
    ...
    const arrNews = [
        {
            name: 'Do Whales Sleep?', date: '22-06-2022 16:27', photo: foto1,
        ...
        {
            name: 'The Great Wall of China', date: '20-05-2022 12:15', photo: foto1,
        ...
        {
            name: 'Reassessing the Impacts of Brain Drain on Developing Countries', date: '03-04-2022 15:01', photo: foto1,
        ...
        {
            name: 'Mickey Mouse', date: '29-03-2022 13:20', photo: foto1,
        ...
        {
            name: 'What does cloud computing mean?', date: '03-03-2022 19:06', photo: foto1,
    ...
    const newsHandler = (e) => {
        setActiveNews(e.currentTarget.id - 1)
    }
                ...
                allNews
                    ...
                    : <>
                        <Box sx={{ flexGrow: 2 }}>
                            ...
                            <Button variant="contained" color='success' sx={{ mb: 2, mr: 1 }}>Add news</Button>
                            <Button variant="contained" color='secondary' sx={{ mb: 2 }}>Next news</Button>
                        </Box>
                        <Box sx={{ flexGrow: 1 }}>
                            {
                                arrNews.map(a => (a.id - 1 !== activeNews) && a.id < 6 && (
                                    <Card key={a.id}
                                        id={a.id}
                                        onClick={newsHandler}
