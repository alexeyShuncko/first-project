...
import { addDiagramm, addActiv, addSalary, addPeriod, addSelectDiagramm, addSalaryValueTrue } from './../../Redux/diagrammReducer';
            ...
            <div className={s.newsItems}>
                <div>
                    <FormDiagram
                        ...
                        addSalaryValueTrue={this.props.addSalaryValueTrue}
                    />
                </div>
